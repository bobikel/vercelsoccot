        ...
        <div className=" px-6 lg:px-16 md:px-10  h-full pt-[40px] w-full ">
          <div className="relative z-40  ">
            <div className='grid grid-cols-1 md:grid-cols-2'>
              <div className="text-start max-w-[900px] text-white grid gap-y-4">
                ...
                <h2 className=' font-bold md:text-[18px] my-2 md:px-[30px] text-center px-2'>VIieme CONGRES ANNUEL</h2>
              ...
              <div className='h-full flex flex-col justify-center text-center gap-y-4 px-10 mt-5 md:mt-0'>
